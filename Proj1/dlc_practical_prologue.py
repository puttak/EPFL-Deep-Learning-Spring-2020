...
# This argument was added to have the possibility to run test.py with options
parser.add_argument('--trainall',
                    action='store_true', default=False,
                    help = 'Train all 4 architectures instead of only the most efficient one')
